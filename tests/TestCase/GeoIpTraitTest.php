...
class GeoIpTraitTest extends TestCase {
    ...
    public function testGeoIpLegacy() {
        $gi = geoip_open(ROOT . DS . 'data' . DS . 'GeoLiteCity.dat', GEOIP_STANDARD);
        echo geoip_country_code_by_addr($gi, "24.24.24.24") . "\t" .
             geoip_country_name_by_addr($gi, "24.24.24.24") . "\n";

        $gi = geoip_open(ROOT . DS . 'data' . DS . 'GeoLiteCityv6.dat', GEOIP_STANDARD);
        echo geoip_country_code_by_addr($gi, "2a00:1a48:7807:103:be76:4eff:fe08:8a20") . "\t" .
             geoip_country_name_by_addr($gi, "2a00:1a48:7807:103:be76:4eff:fe08:8a20") . "\n";
    }

    public function testGeoIpV2() {
        return;
